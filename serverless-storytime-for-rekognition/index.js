...
exports.handler = async (event) => {
    ...
    var data="";
    try {
        data = await rekognition.detectText(rekognitionParams).promise();
    ...
    try {
        ...
        sqs.deleteMessage(deleteParams, function(err, result) {
            ...
            //    console.log("Success to remove messageQueue: "+id+", deleting messagQueue: ", result.ResponseMetadata.RequestId);
            }
        });
    } catch (err) {
        console.log(err);
